<?php /*a:1:{s:43:"G:\tp\app\admin\view\admin\member-list.html";i:1552211627;}*/ ?>
    ...
    <div class="x-body">
      ...
      <table class="layui-table x-admin">
        ...
        <?php if(is_array($users) || $users instanceof \think\Collection || $users instanceof \think\Paginator): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "无数据" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo htmlentities($user['gender_name']); ?></td>
      ...
      <!--<div class="page">
        <div>
          ...
          <span class="current"><?php echo htmlentities($user_list['current_page']); ?></span>
          <a class="num" href="javascript:;">3</a>
          <a class="num" href="javascript:;"><?php echo htmlentities($user_list['total']); ?></a>
