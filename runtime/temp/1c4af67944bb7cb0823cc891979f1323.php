<?php /*a:1:{s:43:"E:\tp\tp\app\admin\view\admin\role-add.html";i:1552268781;}*/ ?>
<!DOCTYPE html>
        ...
        <form id="form" method="post" class="layui-form layui-form-pane">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    autocomplete="off" class="layui-input" placeholder="如兰">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="tel" id="tel" name="tel" lay-verify="required|phone" autocomplete="off" class="layui-input" placeholder="正确手机号">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="mail" id="mail" name="mail" lay-verify="mail" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item" id="x-city">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="detail" name="detail" autocomplete="off" class="layui-input" placeholder="详细地址">
                </div>
            </div>
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
              $.post('adduser',$('#form').serialize(),function(res){
                  if (res.status == 1) {
                      //发异步，把数据提交给php
